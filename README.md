...
<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C2.md'>풀이</link>

<h3>문제3 (210520)</h3>
단어들이 담긴 배열 strs에 대해 배열 안의 단어들 간 공통된 시작 문자를 반환하는 함수 sameStart를 만들어라.

<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C3.md'>풀이</link>

<h3>문제4 (210520)</h3>
1~3999 사이의 로마자 rom을 인자로 받아 그것을 아라비아 숫자로 반환해주는 함수를 만들어라.

<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C4.md'>풀이</link>

<h3>문제5 (210521)</h3>
숫자로 이루어진 배열 nums를 인자로 받아 배열 내에서 과반수가 넘는 요소를 반환하는 함수 majority를 만들어라.

<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C5.md'>풀이</link>

<h3>문제6 (210524)</h3>
여러 괄호들로 이루어진 string 인자 brac에 대하여 brac이 유효한 표현인지를 판별하는 함수 bracket을 만들어라.

<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C6.md'>풀이</link>

<h3>문제7 (210525)</h3>
숫자로 이루어진 배열 nums와 임의의 수 mode를 인자로 받아<br/>
nums 배열 안에서 가장 자주 등장한 숫자를 mode의 개수만큼 return하는 함수를 만들어라.

<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C7.md'>풀이</link>

<h3>문제8 (210526)</h3>
string으로 이루어진 복소수(complex number)인 input1과 input2를 인자로 받아<br/>
두 수를 곱한 값을 반환하는 함수를 만들어라.

<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C8.md'>풀이</link>
...
<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C10.md'>풀이</link>
...
<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C11.md'>풀이</link>

<h3>문제12 (210601)</h3>
양수 num을 인자로 받아 이진법으로 변환했을 때<br/>
연속으로 이어지는 0의 갯수가 가장 큰 값을 return하는 함수를 만들어라.

<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C12.md'>풀이</link>

<h3>문제13 (210602)</h3>
배열 nums를 인자로 받아 버블정렬 알고리즘으로 배열을 정렬해주는 함수를 만들어라.<br/>

<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C13.md'>풀이</link>

<h3>문제14 (210603)</h3>
문자열 str을 인자로 받아, 이를 재귀함수를 통해 뒤집어 return 하는 함수를 만들어라.

<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C14.md'>풀이</link>

<h3>문제15 (210607)</h3>
linkedList를 만들 수 있는 MyLinkedList class를 만들어라.

<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C15.md'>풀이</link>
...
<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C23.md'>풀이</link>
...
<a href='https://github.com/MGanom/Algorithm/blob/main/%EB%AC%B8%EC%A0%9C29.md'>풀이</link>
