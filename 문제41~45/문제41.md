...
function solution(n, build_frame) {
  ...
  for (let i = 0; i < build_frame.length; i++) {
    ...
    if (item[2] === 0) {
      ...
      if (item[3] === 0) {
        if (
          (Math.min(...pillar) !== Number(String(x) + String(y)) &&
            Math.max(...pillar) !== Number(String(x) + String(y + 1))) ||
          !plate.includes(String(x) + String(y + 1))
        ) {
      ...
      if (item[3] === 0) {
        if (
          (!plate.includes(String(x) + String(y)) &&
            !plate.includes(String(x + 1) + String(y))) ||
          (pillar.includes(String(x) + String(y)) &&
            pillar.includes(String(x) + String(y - 1)))
        ) {
